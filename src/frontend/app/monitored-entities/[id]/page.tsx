...
export default function MonitoredEntityDetailPage() {
  ...
  useEffect(() => {
    const fetchEntity = async () => {
      try {
        ...
        console.error("Failed to fetch monitored entity:", err)
        setError(err instanceof Error ? err.message : "Failed to fetch monitored entity")
      } finally {
        setLoading(false)
      }
    }
  ...
  return (
    <div className="p-8 bg-page-background text-page-foreground min-h-screen">
      <div className="mb-6">
        <Link href="/monitored-entities" className="inline-flex items-center text-blue-400 hover:text-blue-300 mb-4">
          <ArrowLeft className="w-4 h-4 mr-2" />
          Back to Monitored Entities
        </Link>
      ...
      {error && <div className="mb-4 p-3 bg-red-900/20 border border-red-800 rounded text-red-400">{error}</div>}
      ...
      {isEditMode ? (
              ...
              <div className="space-y-2">
                ...
                {loadingTypes ? (
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
          <div className="space-y-6">
            {/* Basic Information */}
            <div>
              <h2 className="text-xl font-semibold mb-4 pb-2 border-b border-gray-800">Basic Information</h2>
            ...
            {entity.data_source && (
              <div>
                <h2 className="text-xl font-semibold mb-4 pb-2 border-b border-gray-800">Data Source</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
